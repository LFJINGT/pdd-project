<template>
  <div class="shopcar-container">
    <div class="goods-list">
      <!--      购物车商品列表-->
      <div class="mui-card">
        <div v-for="(item) in goodslist" :key="item.id" class="mui-card-content">
          <div class="mui-card-content-inner flex">
            <!-- 复选框 -->
            <div class="mui-input-row mui-checkbox mui-left">
              <label>&nbsp;</label>
              <input v-model="getGoodsSelected[item.id]" type="checkbox"
            ...
            <div class="info">
              ...
              <p class="flex">
                ...
                <!--                加入NumBox组件-->
                <num-box :goodsid="item.id" :initcount="item.count" :size="'small'"
